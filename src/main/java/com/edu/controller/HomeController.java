...
public class HomeController {
	 ...
	 * router(루트root X)
	 * return 값으로 view(jsp)를 선택해서 작업한 결과를 변수로 담아서 화년에 전송후 결과를 표시(렌더링) 합니다
	 * 폼 전송시 post(자료숨김), get(자료노출-URL쿼리스트링?있는자료전송)
	 */
	...
	public String homepage(Model model) { //콜백 메서드 자동실행됨
		...
		logger.info("디버그스프링로고사용: " + jspVar);//System.out 대신 logger 객체를 사용
