...
public class ExceptionTest {
	...
	public static void main(String[] args) {
		...
		// 위 처럼 동일 패키지 안의 클래스는 import없이 사용 가능합니다
